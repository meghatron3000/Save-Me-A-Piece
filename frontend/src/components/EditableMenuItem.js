...
class EditableMenuItem extends Component {
    ...
    addItem(){
        var self = this;
        axios.post('http://ec2-3-16-46-64.us-east-2.compute.amazonaws.com/api/dishes/', { restaurant_email: self.props.restaurantEmail, restaurant_name: self.props.restaurantName, name: self.state.item, price:self.state.price, servings:self.state.servings })
