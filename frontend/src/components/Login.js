...
class Login extends Component {
    ...
    onLogin(history){
        this.state.url === "rhome"?
            axios.get('http://ec2-3-17-204-188.us-east-2.compute.amazonaws.com/api/restaurants/', 
              { 
                params:{
        ...
        :
            axios.get('http://ec2-3-17-204-188.us-east-2.compute.amazonaws.com/api/nonprofits/', 
            {
                params:{
                    email: this.state.email,
                    password: this.state.password
