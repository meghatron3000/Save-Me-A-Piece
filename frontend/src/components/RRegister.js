...
class RRegister extends Component {
    ...
    onRegister(history){
        // axios.post('http://ec2-3-17-204-188.us-east-2.compute.amazonaws.com/api/schedules/create_with_email', 
        ...
        axios.post('http://ec2-3-17-204-188.us-east-2.compute.amazonaws.com/api/restaurants/', 
            body
        )
        .then(function (response) {
