...
class RestaurantSearchPage extends Component {
    ...
    onSubmit= () =>{
        axios.get('http://ec2-3-16-46-64.us-east-2.compute.amazonaws.com/api/nonprofits/underbudget_rests_near/', 
          { 
            params:{
        ...
        axios.get('http://ec2-3-16-46-64.us-east-2.compute.amazonaws.com/api/nonprofits/overbudget_rests_near/', 
          { 
            params:{
                price: this.state.budget,
                city: this.state.nonProfit.city,
