...
class EditPage extends Component {
    ...
    onChangeMonday(){
        ...
        axios.put('http://ec2-3-17-204-188.us-east-2.compute.amazonaws.com/api/schedules/change_mondaystart', 
        body
      )
      ...
      axios.put('http://ec2-3-17-204-188.us-east-2.compute.amazonaws.com/api/schedules/change_mondayend', 
        body2
      )
      .then(function (response) {
          console.log(response);
    ...
    onChangeTuesday(){
        ...
        axios.put('http://ec2-3-17-204-188.us-east-2.compute.amazonaws.com/api/schedules/change_tuesdaystart', 
        body
      )
      .then(function (response) {
          console.log(response);
      ...
      axios.put('http://ec2-3-17-204-188.us-east-2.compute.amazonaws.com/api/schedules/change_tuesdayend', 
        body2
      )
      .then(function (response) {
          console.log(response);
    ...
    onChangeWednesday(){
        ...
        axios.put('http://ec2-3-17-204-188.us-east-2.compute.amazonaws.com/api/schedules/change_wednesdaystart', 
        body
      )
      .then(function (response) {
          console.log(response);
      ...
      axios.put('http://ec2-3-17-204-188.us-east-2.compute.amazonaws.com/api/schedules/change_wednesdayend', 
        body2
      )
      .then(function (response) {
          console.log(response);
    ...
    onChangeThursday(){
        ...
        axios.put('http://ec2-3-17-204-188.us-east-2.compute.amazonaws.com/api/schedules/change_thursdaystart', 
        body
      )
      .then(function (response) {
          console.log(response);
      ...
      axios.put('http://ec2-3-17-204-188.us-east-2.compute.amazonaws.com/api/schedules/change_thursdayend', 
        body2
      )
      .then(function (response) {
          console.log(response);
    ...
    onChangeFriday(){
        ...
        axios.put('http://ec2-3-17-204-188.us-east-2.compute.amazonaws.com/api/schedules/change_fridaystart', 
        body
      )
      .then(function (response) {
          console.log(response);
      ...
      axios.put('http://ec2-3-17-204-188.us-east-2.compute.amazonaws.com/api/schedules/change_fridayend', 
        body2
      )
      .then(function (response) {
          console.log(response);
    ...
    onChangeSaturday(){
        ...
        axios.put('http://ec2-3-17-204-188.us-east-2.compute.amazonaws.com/api/schedules/change_saturdaystart', 
        body
      )
      .then(function (response) {
          console.log(response);
      ...
      axios.put('http://ec2-3-17-204-188.us-east-2.compute.amazonaws.com/api/schedules/change_saturdayend', 
        body2
      )
      .then(function (response) {
          console.log(response);
    ...
    onChangeSunday(){
        ...
        axios.put('http://ec2-3-17-204-188.us-east-2.compute.amazonaws.com/api/schedules/change_sundaystart', 
        body
      )
      .then(function (response) {
          console.log(response);
      ...
      axios.put('http://ec2-3-17-204-188.us-east-2.compute.amazonaws.com/api/schedules/change_sundayend', 
        body2
      )
      .then(function (response) {
          console.log(response);
