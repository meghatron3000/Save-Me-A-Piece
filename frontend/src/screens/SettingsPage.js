...
class SettingsPage extends Component {
    ...
    onDelete(history){
        this.state.url === "rhome"?
            axios.delete('http://ec2-3-16-46-64.us-east-2.compute.amazonaws.com/api/restaurants/', 
              { 
                params:{
        ...
        :
            axios.delete('http://ec2-3-16-46-64.us-east-2.compute.amazonaws.com/api/nonprofits/', 
            {
                params:{
                    email: this.state.email,
                }
