...
class MenuPage extends Component {
    ...
    componentDidMount(){
        var self = this;
        axios.get('http://ec2-3-16-46-64.us-east-2.compute.amazonaws.com/api/dishes/', 
              { 
                params:{
    ...
    deleteItem(restaurantEmail, itemName){
        var self = this;
        axios.delete('http://ec2-3-16-46-64.us-east-2.compute.amazonaws.com/api/dishes/', { data: { restaurant_email: restaurantEmail, name: itemName } })
        .then(function (response){
            if(response.data.message === "SUCCESS"){
