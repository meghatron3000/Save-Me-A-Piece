...
def dishes(request, format=None):
    if request.method == 'POST': #register nonprofit
        ...
        cursor.execute('INSERT INTO dishes ("restaurant_email", "restaurant_name", "name", "price", "servings", "listing_time") VALUES( %s, %s, %s, %s, %s)' , [ body["restaurant_email"],  body["restaurant_name"], body["name"], body["price"], body["servings"], body["time"] ])
